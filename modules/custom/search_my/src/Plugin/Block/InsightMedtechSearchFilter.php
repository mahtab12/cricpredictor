 ...
 *
 * @Block(
 *  id = "insight_medtech_search_filter",
 *  admin_label = @Translation("Insight Medtech Search Filter"),
 * )
 */
class InsightMedtechSearchFilter extends BlockBase
{
  ...
  public function build()
  {
    ...
    $form = \Drupal::formBuilder()->getForm('Drupal\insight_search\Form\MedtechSearchFilterForm');
