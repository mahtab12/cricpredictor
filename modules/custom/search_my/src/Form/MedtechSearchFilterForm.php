...
/**
 * Description of MedtechSearchFilterForm
 *
 * @author sakreddy
 */
class MedtechSearchFilterForm extends \Drupal\Core\Form\FormBase {

  //put your code here
  public function getFormId(): string {
    return 'medtech_search_filter_form';
  }
...
//    ));
    ...
    $link = \Drupal\Core\Link::createFromRoute('Reset all', 'insight.market.access.searchusaccess', ['query' => $request->get('query')], ['attributes' => ['class' => ['pull-right', 'btn-clearall']]]);
...
// var_dump($geo);die;
    ...
    $form['geo'] = [
        ...
        '#title' => 'Geography',
        '#name' => 'geo',
        '#options' => ['states' => 'sdsd', 'metroareas' => 'sdsdsdsd', 'favorites' => 'sdasdasdsd'],
        '#default_value' => $geo,
