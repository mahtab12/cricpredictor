 ...
 *
 * @Block(
 *   id = "stats_analysis_block",
 *   admin_label = @Translation("Status and Analytics"),
 *   category = @Translation("Status and Analytics"),
 * )
 */
class StatsAndAnalysisBlock extends BlockBase {
  ...
  public function build() {
    ...
    $build['stats_and_analysis'] = [
      '#theme' => 'stats_and_analysis',
...
//    print_r("Here");
    ...
    $query->condition('fsc.field_article_type_value', 'Stats and Analysis');
